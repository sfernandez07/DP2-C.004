...
<acme:form>
    ...
    <acme:input-select code="airline-manager.flight-leg.form.label.departureAirport" path="departureAirport" choices="${departureAirportChoices}"/>
	<acme:input-select code="airline-manager.flight-leg.form.label.arrivalAirport" path="arrivalAirport" choices="${arrivalAirportChoices}"/>
	<acme:input-select code="airline-manager.flight-leg.form.label.aircraft" path="aircraft" choices="${aircraftChoices}"/>
    <acme:input-double code="airline-manager.flight-leg.form.label.durationHours" path="durationHours" readonly="True"/>
    ...
    <jstl:when test="${_command == 'create' && allowCreate}">
        <acme:submit code="airline-manager.flight-leg.form.button.create" action="/airline-manager/flight-leg/create?masterId=${masterId}"/>
    </jstl:when>
</jstl:choose>
