...
<%@tag import="java.util.Collection, acme.client.helpers.JspHelper" body-content="empty"%>
...
<%@attribute name="choices" required="true" type="acme.client.components.views.SelectChoices"%>
